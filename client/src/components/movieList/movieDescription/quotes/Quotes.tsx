...
const Quote: React.FC = () => {
  ...
  return (
    <section className={style.quote}>
      {quoteMode === "editQUote" && <EditQuote setQuoteMode={setQuoteMode} />}
      {quoteMode === "viewQuote" && <ViewQuote setQuoteMode={setQuoteMode} />}
      <article className={style.quoteTitle}>
        <div className={style.quotePhoto}>
          <img src={movieImg} alt="img" />
        </div>
        <h4>"Frankly, my dear, I don'tgive a damn."</h4>
        <div className={style.menuDot} onClick={() => setQuoteMenu(!quoteMenu)}>
          {quoteMenu && <QuoteMenu setQuoteMode={setQuoteMode} />}
          <svg
            width="20"
            height="6"
            viewBox="0 0 20 6"
